...
pred init {
    ...
    task1.outgoingSequenceFlows.target = intermediateCatchEvent1
    ...
    intermediateCatchEvent1.incomingSequenceFlows.source = task1
...
run System for 1 StartEvent, 2 Task, 0 ExGate, 0 PaGate, 0 EventBasedGateway, 1 IntermediateCatchEvent, 1 IntermediateThrowEvent, 1 EndEvent, 0 TerminateEndEvent, 0 SubProcess, 4 SequenceFlow, 1 Process, 3 Token, 1 ProcessSnapshot, 1 Event, 10 steps
