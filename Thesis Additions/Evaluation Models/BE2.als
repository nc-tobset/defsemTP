...
pred init {
    #exclusiveGateway1.outgoingSequenceFlows = 2
    exclusiveGateway1.outgoingSequenceFlows.target = task2 + task3
    ...
    task3.outgoingSequenceFlows.target = endEvent2
    #startEvent1.outgoingSequenceFlows = 1
    startEvent1.outgoingSequenceFlows.target = task1
    #exclusiveGateway1.incomingSequenceFlows = 1
    exclusiveGateway1.incomingSequenceFlows.source = task1
    #task1.incomingSequenceFlows = 1
    task1.incomingSequenceFlows.source = startEvent1
    #task2.incomingSequenceFlows = 1
    task2.incomingSequenceFlows.source = exclusiveGateway1
    #endEvent2.incomingSequenceFlows = 1
    endEvent2.incomingSequenceFlows.source = task3
    #task3.incomingSequenceFlows = 1
    task3.incomingSequenceFlows.source = exclusiveGateway1
...
run System for 1 StartEvent, 3 Task, 1 ExGate, 0 PaGate, 0 EventBasedGateway, 0 IntermediateCatchEvent, 0 IntermediateThrowEvent, 2 EndEvent, 0 TerminateEndEvent, 0 SubProcess, 6 SequenceFlow, 1 Process, 2 Token, 1 ProcessSnapshot, 1 Event, 12 steps
