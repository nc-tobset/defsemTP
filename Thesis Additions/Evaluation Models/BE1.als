...
pred init {
    ...
    parallelGatewayOpening1.outgoingSequenceFlows.target = task1 + task2
    #task1.outgoingSequenceFlows = 1
    task1.outgoingSequenceFlows.target = parallelGatewayClosing1
    ...
    startEvent1.outgoingSequenceFlows.target = parallelGatewayOpening1
    #parallelGatewayClosing1.incomingSequenceFlows = 2
    parallelGatewayClosing1.incomingSequenceFlows.source = task1 + task2
    #parallelGatewayOpening1.incomingSequenceFlows = 1
    parallelGatewayOpening1.incomingSequenceFlows.source = startEvent1
    #task1.incomingSequenceFlows = 1
    task1.incomingSequenceFlows.source = parallelGatewayOpening1
...
run System for 1 StartEvent, 2 Task, 0 ExGate, 2 PaGate, 0 EventBasedGateway, 0 IntermediateCatchEvent, 0 IntermediateThrowEvent, 1 EndEvent, 0 TerminateEndEvent, 0 SubProcess, 6 SequenceFlow, 1 Process, 3 Token, 1 ProcessSnapshot, 1 Event, 13 steps